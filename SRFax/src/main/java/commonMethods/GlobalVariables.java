...
public class GlobalVariables {
	public static final String HOME_PAGE = "https://qasecure.srfax.com/client/login.php";
	public static final String STANDARD_USER = "257970";
	public static final String ALL_USER_PWD = "Test@12345";
